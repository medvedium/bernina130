...
var burgerMenu = document.querySelector('nav.nav');
var backdrop = document.querySelector('.backdrop');
var burgerClose = document.querySelector('.nav .close-burger');
...
burgerButton.addEventListener('click', function () {
  ...
  burgerMenu.querySelectorAll('.nav__link').forEach(function (item) {
...
var modal = document.querySelector('.modal.modal-payment');
var modalSuccess = document.querySelector('.modal.modal-success');
var backdrop = document.querySelector('.backdrop');
  ...
  if (!button.closest('.modal-payment')) {
    button.addEventListener('click', function () {
      ...
      if (button.dataset.target) {
        modal.querySelector("[id=\"".concat(button.dataset.target, "\"]")).click();
        modal.querySelector("[id=\"".concat(button.dataset.target, "\"]")).closest('.price-item').querySelector('.button').textContent = 'Выбрано';
      }
      modal.querySelectorAll('input[type="radio"]').forEach(function (item) {
        if (item.checked) {
    ...
    if (button.closest('.price-item')) {
      button.addEventListener('click', function (e) {
        ...
        modal.querySelectorAll('.price-item .button').forEach(function (item) {
...
var initMask = function initMask() {
  ...
  for (var _i = 0; _i < phoneInputs.length; _i++) {
    phoneInputs[_i].addEventListener('input', createMask);
  }
  try {
...
document.addEventListener('DOMContentLoaded', function () {
  var deadline = new Date(2023, 7, 5);
  // id таймера
  var timerId = null;
  ...
  var $days = document.querySelector('.hero-timer__days');
  var $hours = document.querySelector('.hero-timer__hours');
  var $minutes = document.querySelector('.hero-timer__minutes');
  var $seconds = document.querySelector('.hero-timer__seconds');
...
var burger = __webpack_require__(676);
// EXTERNAL MODULE: ./src/js/timer.js
var timer = __webpack_require__(651);
// EXTERNAL MODULE: ./src/js/phoneMask.js
var phoneMask = __webpack_require__(654);
...
;// CONCATENATED MODULE: ./src/js/marquee.js


var splide = new Splide('.marquee__wrap', {
  type: 'loop',
  drag: 'free',
  focus: 'center',
  perPage: 5,
